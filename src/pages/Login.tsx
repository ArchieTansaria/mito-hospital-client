...
const MOCK_HOSPITALS = [
  { id: '1', name: 'General Hospital', code: 'GH1234' },
  { id: '2', name: 'City Medical Center', code: 'CMC5678' },
  { id: '3', name: 'County Hospital', code: 'CH9012' },
];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mt-4 text-gray-900">Health Nexus</h1>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          ...
          <div className="mt-2 grid grid-cols-3 gap-2">
            {MOCK_HOSPITALS.map((h) => (
              <div key={h.id} className="text-xs p-1 bg-gray-100 rounded">
                {h.code}
              </div>
            ))}
          </div>
