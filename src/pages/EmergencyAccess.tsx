    ...
    setTimeout(() => {
      if (activeTab === 'phone') {
        ...
        if (records) {
          ...
          setError('No emergency data found for this patient');
          toast({
            title: "Access Failed",
            description: "No emergency data available for this phone number",
            variant: "destructive",
          });
        }
      } else {
        ...
        if (!/^[A-Za-z0-9]{6}$/.test(emergencyPin)) {
          setError('Please enter a valid 6-character emergency PIN');
          setIsLoading(false);
          return;
        }
        ...
        if (pinData) {
          ...
          setError('Invalid emergency PIN');
          toast({
            title: "Access Failed",
            description: "The emergency PIN you entered is not valid",
            variant: "destructive",
          });
        }
      }
